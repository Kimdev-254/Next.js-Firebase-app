...
const Dashboard = () => {
  ...
  return (
    <div className="max-w-7xl bg-foreground  text-gray-300 font-serif  mx-auto mt-8">
      <h2 className="text-3xl flex justify-center font-semibold font-sans mb-4">
        Submissions
      </h2>
      <ul>
        {submissions.map((submission) => (
          <li
            key={submission.id}
            className="bg-[#003403] mb-4 p-4 rounded-lg border border-gray-600"
          >
            <div className="flex justify-center mb-4 p-2 bg-foreground rounded">
              <h2 className="font-bold text-lg">
                <i>{submission.fullname}</i>
              </h2>
            </div>
            <div className="grid grid-cols-4 gap-4">
              <div className="border-zinc-900">
                ...
                <p>
                  <strong>Adm No:</strong> {submission.admno}
                </p>
                <p>
                  <strong>Contact:</strong> {submission.contact}
                </p>
                <p>
              ...
              <div>
                ...
                <p>
                  <strong>Institution:</strong> {submission.institution}
                </p>
                <p>
              ...
              <div>
                ...
                <p>
                  <strong>Commenced:</strong> {submission.commenced}
                </p>
                <p>
                  <strong>Completed:</strong> {submission.completed}
                </p>
              </div>
              <div>
                <h3 className="font-semibold mb-2">Document Info</h3>
                <p>
                  <strong>No. of Pages:</strong> {submission.numPages}
                </p>
                <p>
